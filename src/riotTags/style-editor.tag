    ...
    #styleleft.tall.flexfix
        ...
        .tabwrap.flexfix-body
            ul.nav.tabs.nogrow.noshrink
                li.tab(onclick='{changeTab(\'stylefont\')}', class='{active: === \'stylefont\'}') {voc.font}
                li.tab(onclick='{changeTab(\'stylefill\')}', class='{active: === \'stylefill\'}') {voc.fill}
                li.tab(onclick='{changeTab(\'stylestroke\')}', class='{active: === \'stylestroke\'}') {voc.stroke}
                li.tab(onclick='{changeTab(\'styleshadow\')}', class='{active: === \'styleshadow\'}') {voc.shadow}
            #stylefont.tabbed(show='{tab === \'stylefont\'}')
                #stylefontinner
                    fieldset
                        b {voc.fontfamily}
                        input#fontfamily.wide(
                            type='text',
                            value='{styleobj.font.family || \'sans-serif\'}',
                            onchange='{wire(\'this.styleobj.font.family\')}'
                        )
                        .fifty.npl.npt
                            b {voc.fontsize}
                            br
                            input#fontsize.wide(
                                type='number',
                                value='{styleobj.font.size || \'12\'}',
                                onchange='{wire(\'this.styleobj.font.size\')}',
                                oninput='{wire(\'this.styleobj.font.size\')}',
                                step='1'
                            )
                        .fifty.npr.npt
                            b {voc.fontweight}
                            br
                            select.wide(
                                value='{styleobj.font.weight}',
                                onchange='{wire(\'this.styleobj.font.weight\')}'
                            )
                        ...
                        label.checkbox
                            input(
                                type='checkbox',
                                checked='{styleobj.font.italic}',
                                onchange='{wire(\'this.styleobj.font.italic\')}'
                            )
                            span {voc.italic}
                    fieldset
                        b {voc.alignment}
                        .align.buttonselect
                            button#middleleft.inline.nml(
                                onclick='{styleSetAlign(\'left\')}',
                                class='{active: this.styleobj.font.halign === \'left\'}'
                            )
                                svg.feather
                                    use(xlink:href='data/icons.svg#align-left')
                            button#middlecenter.inline(
                                onclick='{styleSetAlign(\'center\')}',
                                class='{active: this.styleobj.font.halign === \'center\'}'
                            )
                                svg.feather
                                    use(xlink:href='data/icons.svg#align-center')
                            button#middleright.inline(
                                onclick='{styleSetAlign(\'right\')}',
                                class='{active: this.styleobj.font.halign === \'right\'}'
                            )
                                svg.feather
                        ...
                        label
                            ...
                            input(
                                ...
                                step='1',
                                min='0',
                                value='{styleobj.font.lineHeight || 0}',
                                oninput='{wire(\'this.styleobj.font.lineHeight\')}'
                            )
                    fieldset
                        label.checkbox
                            input(
                                type='checkbox',
                                checked='{styleobj.font.wrap}',
                                onchange='{wire(\'this.styleobj.font.wrap\')}'
                            )
                            b {voc.textWrap}
                        label.block.nmt(if='{styleobj.font.wrap}')
                            b {voc.textWrapWidth}
                            input.wide(
                                type='number',
                                step='8',
                                min='1',
                                value='{styleobj.font.wrapPosition || 100}',
                                oninput='{wire(\'this.styleobj.font.wrapPosition\')}'
                            )

            #stylefill.tabbed(show='{tab === \'stylefill\'}')
                label.checkbox
                    input#iftochangefill(
                        type='checkbox',
                        checked='{\'fill\' in styleobj}',
                        onchange='{styleToggleFill}'
                    )
                    span {voc.active}
                #stylefillinner(if='{styleobj.fill}')
                    fieldset
                        ...
                        label.checkbox
                            input(
                                ...
                                value='0',
                                name='filltype',
                                checked='{styleobj.fill.type == 0}',
                                onchange='{wire(\'this.styleobj.fill.type\')}'
                            )
                            span {voc.fillsolid}
                        label.checkbox
                            input(
                    ...
                    fieldset
                        .solidfill(if='{styleobj.fill.type == 0}')
                            ...
                            br
                            color-input(
                                onchange='{wire(\'this.styleobj.fill.color\', true)}',
                        ...
                        .gradientfill(if='{styleobj.fill.type == 1}')
                            .fifty.npl.npt
                                b {voc.fillcolor1}
                                color-input(
                                    onchange='{wire(\'this.styleobj.fill.color1\', true)}',
                                    color='{styleobj.fill.color1}'
                                )
                            .fifty.npr.npt
                                b {voc.fillcolor2}
                                color-input(
                                    onchange='{wire(\'this.styleobj.fill.color2\', true)}',
                                    color='{styleobj.fill.color2}'
                                )
                            .clear
                            b {voc.fillgradtype}
                            label.checkbox
                                input(
                                    ...
                                    value='2',
                                    name='fillgradtype',
                                    onchange='{wire(\'this.styleobj.fill.gradtype\')}'
                                )
            ...
            #stylestroke.tabbed(show='{tab === \'stylestroke\'}')
                label.checkbox
                    input#iftochangestroke(
                        type='checkbox',
                        checked='{\'stroke\' in styleobj}',
                        onchange='{styleToggleStroke}'
                    )
                    span {voc.active}
                #stylestrokeinner(if='{styleobj.stroke}')
                    fieldset
                        b {voc.strokecolor}
                        color-input(
                            onchange='{wire(\'this.styleobj.stroke.color\', true)}',
                    ...
                    fieldset
                        ...
                        input#strokeweight(
                            type='number',
                            value='{styleobj.stroke.weight}',
                            onchange='{wire(\'this.styleobj.stroke.weight\')}',
                            oninput='{wire(\'this.styleobj.stroke.weight\')}'
                        )
                    #strokeweightslider
            #styleshadow.tabbed(show='{tab === \'styleshadow\'}')
                label.checkbox
                    input#iftochangeshadow(
                        type='checkbox',
                        checked='{\'shadow\' in styleobj}',
                        onchange='{styleToggleShadow}'
                    )
                    span {voc.active}
                #styleshadowinner(if='{styleobj.shadow}')
                    fieldset
                        b {voc.shadowcolor}
                        color-input(
                            onchange='{wire(\'this.styleobj.shadow.color\', true)}',
                            color='{styleobj.shadow.color}'
                        )
                    fieldset
                        b {voc.shadowshift}
                        br
                        input#shadowx.short(
                            type='number',
                            value='{styleobj.shadow.x}',
                            onchange='{wire(\'this.styleobj.shadow.x\')}',
                            oninput='{wire(\'this.styleobj.shadow.x\')}'
                        )
                        | ×
                        input#shadowy.short(
                            type='number',
                            value='{styleobj.shadow.y}',
                            onchange='{wire(\'this.styleobj.shadow.y\')}',
                            oninput='{wire(\'this.styleobj.shadow.y\')}'
                        )
                    fieldset
                        b {voc.shadowblur}
                        br
                        input#shadowblur(
                            type='number',
                            value='{styleobj.shadow.blur}',
                            min='0',
                            onchange='{wire(\'this.styleobj.shadow.blur\')}',
                            oninput='{wire(\'this.styleobj.shadow.blur\')}'
                        )
        .flexfix-footer
