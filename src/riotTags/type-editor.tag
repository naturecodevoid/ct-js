    ...
    .c3.tall.flexfix
        .flexfix-header
            #typetexture.panel(onclick='{changeSprite}')
                img.ohchangeme(
                    src='{type.texture === -1? \'data/img/notexture.png\' : (glob.texturemap[type.texture].src.split(\'?\')[0] + \'_prev@2.png?\' + getTypeTextureRevision(type)) + getTypeTextureRevision(type)}'
                )
                div {voc.change}
            b {voc.name}
    ...
    .c9.tall.borderleft
        .tabwrap.tall(style='position: relative')
            ul.tabs.nav.nogrow.noshrink
                li.tab(
                    onclick='{changeTab(\'typeoncreate\')}',
                    class='{active: === \'typeoncreate\'}',
                    title='{voc.create} (Control+Q)',
                ...
                li.tab(
                    ...
                    class='{active: === \'typeonstep\'}',
                    title='{voc.step} (Control+W)',
                    ...
                    span {voc.step}
                li.tab(
                    onclick='{changeTab(\'typeondraw\')}',
                    class='{active: === \'typeondraw\'}',
                    title='{voc.draw} (Control+E)',
                    ...
                    span {voc.draw}
                li.tab(
                    onclick='{changeTab(\'typeondestroy\')}',
                    class='{active: === \'typeondestroy\'}',
                    title='{voc.destroy} (Control+R)',
