...
asset-viewer.flexfix(class='{opts.namespace} {opts.class}')
    .flexfix-header
        .toright
            ...
            button.inline.square(onclick='{switchLayout}')
                svg.feather
                    use(
                        xlink:href='data/icons.svg#{localStorage[opts.namespace? (opts.namespace+\'Layout\') : \'defaultAssetLayout\'] === \'list\'? \'grid\' : \'list\'}'
                    )
        .toleft
            <yield/>
        .clear
    .flexfix-body
        ul.cards(
            class='{list: localStorage[opts.namespace? (opts.namespace+\'Layout\') : \'defaultAssetLayout\'] === \'list\'}'
        )
            li(
