    ...
    .panel(ref='widget')
        ...
        .c6.npt.npl.npb
            ...
            .Swatches(ref='localSwatches')
                .aSwatch(
                    each='{colr in global.currentProject.palette}',
        ...
        .c6.npt.npr.npb
            ...
            .flexrow
                .aRangePipeStack
                    .pipe(
                        style='background: linear-gradient(to right, {color.setAlpha(1).desaturateByRatio(1).toCSS()} 0%, {color.setAlpha(1).saturateByAmount(1).toCSS()} 100%)'
                    )
                    input.transparent(
                        type='range',
                        value='{~~(color.getSaturation() * 100)}',
                        min='0',
                        max='100',
            ...
            .flexrow
                .aRangePipeStack
                    .pipe(
                        style='background: linear-gradient(to right, {color.setAlpha(1).devalueByRatio(1).toCSS()} 0%, {color.setAlpha(1).valueByAmount(1).toCSS()} 100%)'
                    )
                    input.transparent(
                        type='range',
            ...
            .flexrow(hide='{opts.hidealpha}')
                .aRangePipeStack
                    .pipe.alphabar
                    .pipe(
                        style='background: linear-gradient(to right, transparent 0%, {color.setAlpha(1).toCSS()} 100%)'
                    )
                    input.transparent(
                        type='range',
                        value='{~~(color.getAlpha() * 100)}',
                        min='0',
                        max='100',
