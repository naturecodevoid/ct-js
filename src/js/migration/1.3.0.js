    ...
    process: project =>
        new Promise(resolve => {
            ...
            project.settings.export = {
                linux:
                    project.settings.export.linux || project.settings.export.linux64 || project.settings.export.linux32,
                windows:
                    project.settings.export.windows ||
                    project.settings.export.windows64 ||
                    project.settings.export.windows32,
